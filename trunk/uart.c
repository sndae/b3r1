...
// Created		: 11/22/2000
// Revised		: 12/09/2006 - James Ronald
// Version		: 1.3.1
// Target MCU	: ATMEL AVR Series
// Editor Tabs	: 4
//
// Changed      : Changed uartSetBaudRate function to use U2X if supported.
//
...
void uartSetBaudRate(u32 baudrate)
{
		...
		// Use USART 2x Usart
		UCSRA |= (1<<U2X);
		// calculate new division factor for U2X baud rate
		u16 bauddiv = ((F_CPU+(baudrate*4L))/(baudrate*8L)-1);
	#else
		// calculate division factor for requested baud rate
